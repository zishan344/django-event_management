...
from events.views import event_delete,update_category,delete_category, dashboard,RoleDetails,Rsvp_event,Delete_participant,CreateCategory,CreateEvent,EventUpdate,EventDetails,EventListView
